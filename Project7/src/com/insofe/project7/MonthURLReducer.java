...
public class MonthURLReducer extends	Reducer<IntWritable, URLCount, IntWritable, Text> {

	 @Override
	  public void reduce(IntWritable key, Iterable<URLCount> values, Context context)
